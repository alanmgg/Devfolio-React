  ...
  return (
    <>
      <div className="flex flex-row lg:text-center">
        <a
          className="mt-4 py-2 px-4 bg-gray-200 shadow-lg shadow-gray-500/20 dark:shadow-gray-200/20 hover:bg-gray-300 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-white flex flex-row items-center rounded cursor-pointer"
        ...
        <a
          className="mt-4 ml-5 py-2 px-4 bg-gray-200 shadow-lg shadow-gray-500/20 dark:shadow-gray-200/20 hover:bg-gray-300 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-white flex flex-row items-center rounded cursor-pointer"
