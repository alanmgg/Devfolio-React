  ...
  return (
    <>
      <div className="flex flex-row lg:text-center">
        <button
          className="mt-4 py-2 px-4 bg-gray-300 hover:bg-gray-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-white flex flex-row items-center rounded"
        ...
        <button
          className="mt-4 ml-5 py-2 px-4 bg-gray-300 hover:bg-gray-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-white flex flex-row items-center rounded"
